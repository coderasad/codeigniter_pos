            ...
            <div class="panel panel-bd lobidrag">
                ...
                <?php 
                    foreach($supplier as $data){?>
                        <form action="<?php echo base_url('supplier/update/').$data->id ?>" method="post" novalidate >                    
                            <div class="panel-body">
                                <div class="form-group row">
                                    <label for="supplier_name" class="col-sm-3 col-form-label text-right">supplier Name <i class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                                        <input class="form-control" name="supplier_name" id="supplier_name" type="text" value="<?php echo $data->name ?>">
                                        ...
                                        <select class="form-control" id="brand_id" name='brand_id'>                                    
                                            ...
                                            <?php  
                                                foreach($brand as $value){?>
                                                    <option value="<?php echo $value->id ?>" <?php echo ($data->brand_id == $value->id) ? 'selected':'' ?>><?php echo $value->name?></option>
                                                <?php }
                                            ?>
                                    ...
                                    <select class="test" id="test" name='category_id' multiple="multiple">
                                        <?php  
                                            foreach($category as $value){?>
                                                <option value="<?php echo $value->id?>" <?php echo ($data->category_id == $value->id) ? 'selected':'' ?>><?php echo $value->name?></option>
                                            <?php }
                                        ?>
                                    </select>  
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="address" id="address " rows="3" placeholder="supplier Address" tabindex="4"><?php echo $data->address ?></textarea>                               
                                    </div>
                                </div>
                                <div class="form-group row">
