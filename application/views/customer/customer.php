                        ...
                        <table id="dataTableExample2xx" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:right !Important">Due Amount</th>
                            ...
                            <tbody>
                                <?php 
                                    foreach($customer as $data){$id = $data->id;?>
                                        <tr>
                                            <td><?php echo $num++ ?></td>
                                            <td><a href="<?php echo base_url('customer/ledger/details/').$id; ?>"><?php echo $data->name ?></a></td>
                                            <td><?php echo $data->address ?></td>
                                            <td><?php echo $data->phone ?></td>
                                            <td style="text-align:center !Important"><a href="<?php echo base_url('transaction/custmer/').$id; ?>">Report</a></td>
                                            <td align="right"><?php echo $data->due_balance + $data->opening_balance?>.00</td> 
                                            <td>
                                                <center>                                                
